...
class StudentReportCards {
    ...
    async loadReportCards() {
        try {
            ...
            const apiUrl = `${window.API_CONFIG?.BASE_URL || 'http://localhost:5000'}/api/marks/student/${studentId}?term=${encodeURIComponent(term)}&academicYear=${encodeURIComponent(academicYear)}`;
