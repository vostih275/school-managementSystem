...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadDashboardStats() {
        ...
        try {
            const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/stats');
    ...
    async function fetchAccounts() {
        try {
            const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/accounts');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (clubForm && clubNameInput && advisorInput) {
            clubForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/clubs', {
                        method: 'POST',
    ...
    async function fetchBooks() {
        try {
            const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/library/books');
    ...
    if (eventForm) {
        eventForm.addEventListener('submit', async (e) => {
            ...
            try {
                const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/events', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    document.getElementById('add-teacher-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/users/teachers', {
                method: 'POST',
    ...
    document.getElementById('add-student-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/users/students', {
                method: 'POST',
    ...
    document.getElementById('broadcast-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch((window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/broadcast', {
                method: 'POST',
    ...
    document.getElementById('backup-btn')?.addEventListener('click', () => {
        window.location.href = (window.API_CONFIG?.BASE_URL || 'http://localhost:5000') + '/api/backup/download';
    });
